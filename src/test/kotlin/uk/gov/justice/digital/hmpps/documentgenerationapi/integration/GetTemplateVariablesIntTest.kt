        ...
        domains = listOf(
          ...
          TemplateVariables.Domain(
            ...
            variables = listOf(
              ...
              TemplateVariables.Variable(code = "sentArdCrd", description = "ARD/CRD", type = Type.DATE),
              TemplateVariables.Variable(code = "sentCrd", description = "CRD", type = Type.DATE),
              TemplateVariables.Variable(code = "sentPed", description = "PED or review date", type = Type.DATE),
              TemplateVariables.Variable(code = "sentSled", description = "SLED", type = Type.DATE),
            ),
          ),
          TemplateVariables.Domain(
